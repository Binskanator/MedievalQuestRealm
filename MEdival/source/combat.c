...
void initCombat(CombatContext* context, Player* player, Enemy* enemy) {
    ...
    snprintf(context->battleMessage, sizeof(context->battleMessage), "A %s appeared!", enemy->name);
}
    ...
    switch (context->state) {
        ...
        case COMBAT_PLAYER_TURN:
            ...
            if (keyPressed(&inputState, KEY_A)) {
                ...
                if (context->enemy->hp > 0) {
                    ...
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "You defeated the %s!", context->enemy->name);
        ...
        case COMBAT_ENEMY_TURN:
            ...
            if (context->player->stats.hp <= 0) {
                ...
                snprintf(context->battleMessage, sizeof(context->battleMessage), "You were defeated!");
        ...
        case COMBAT_VICTORY:
            ...
            if (context->messageTimer == 0) {
                ...
                if (context->enemy->dropRate > 0 && getRandomInt(100) < context->enemy->dropRate) {
                    ...
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "Got %s!", context->enemy->droppedItem.name);
                    context->messageTimer = 60;
                }
            }
            break;
        ...
        case ACTION_ATTACK:
            {
                ...
                // Set message
                snprintf(context->battleMessage, sizeof(context->battleMessage), "You hit for %d damage!", damage);
        ...
        case ACTION_USE_ITEM:
            {
                ...
                if (context->selectedItemIndex == -1) {
                    ...
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "Select an item to use...");
                ...
                if (context->selectedItemIndex >= 0 && 
                    ...
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "Used %s!", item->name);
        ...
        case ACTION_DEFEND:
            {
                ...
                snprintf(context->battleMessage, sizeof(context->battleMessage), "Defending...");
                context->messageTimer = 30;
            }
            break;
        ...
        case ACTION_RUN:
            {
                ...
                if (attemptRun(context)) {
                    ...
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "Got away safely!");
                } else {
                    snprintf(context->battleMessage, sizeof(context->battleMessage), "Couldn't escape!");
                }
                context->messageTimer = 30;
            }
            break;
...
void performEnemyAction(CombatContext* context) {
    ...
    // Set message
    snprintf(context->battleMessage, sizeof(context->battleMessage), "%s hit you for %d damage!", 
